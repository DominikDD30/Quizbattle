...
const Avatar1 = () => (
  <Svg width="100" height="100" viewBox="0 0 200 200">
    <Circle cx="100" cy="100" r="95" fill="#f0f0f0" stroke="#ccc" strokeWidth="5" />
    <Circle cx="100" cy="100" r="50" fill="#ffd1a9" />
    <Circle cx="85" cy="95" r="5" fill="#000" />
    <Circle cx="115" cy="95" r="5" fill="#000" />
    <Path d="M85,125 Q100,140 115,125" stroke="#000" strokeWidth="3" fill="none" />
    <Rect x="60" y="60" width="80" height="15" fill="#90E24A" />
    <Ellipse cx="100" cy="75" rx="50" ry="10" fill="#90E24A" />
...
const Avatar3 = () => (
  <Svg width="100" height="100" viewBox="0 0 200 200">
    <Circle cx="100" cy="100" r="95" fill="#f0f0f0" stroke="#ccc" strokeWidth="5" />
    <Path
      d="M50,140 Q75,90 100,140 T150,140 Q140,120 130,100 T110,70 Q100,60 90,70 T70,100 Q60,120 50,140 Z"
      fill="#76c893"
      stroke="#4a9e69"
      strokeWidth="5"
    />
...
const Avatar6 = () => (
  <Svg width="100" height="100" viewBox="0 0 200 200">
    <Circle cx="100" cy="100" r="95" fill="#f0f0f0" stroke="#ccc" strokeWidth="5" />
    <Rect x="60" y="70" width="80" height="60" rx="15" ry="15" fill="#d32f2f" stroke="#7f8c8d" strokeWidth="4" />
    <Rect x="70" y="80" width="60" height="20" rx="5" ry="5" fill="#b0c4de" stroke="#7f8c8d" strokeWidth="3" />
    <Circle cx="85" cy="100" r="4" fill="#fff" stroke="#000" strokeWidth="2" />
    <Circle cx="115" cy="100" r="4" fill="#fff" stroke="#000" strokeWidth="2" />
    <Rect x="90" y="115" width="20" height="5" fill="#000" />
...
const Avatar7 = () => (
  <Svg width="100" height="100" viewBox="0 0 200 200">
    <Circle cx="100" cy="100" r="95" fill="#f0f0f0" stroke="#ccc" strokeWidth="5" />
    <Polygon points="60,70 140,70 100,30" fill="#4b0082" stroke="#7f8c8d" strokeWidth="4" />
    <Rect x="65" y="70" width="70" height="10" fill="#4b0082" stroke="#7f8c8d" strokeWidth="4" />
    <Rect x="65" y="80" width="70" height="60" rx="15" ry="15" fill="#9370db" stroke="#7f8c8d" strokeWidth="4" />
    <Circle cx="85" cy="100" r="4" fill="black" stroke="black" strokeWidth="1" />
    <Circle cx="115" cy="100" r="4" fill="black" stroke="black" strokeWidth="1" />
    <Rect x="90" y="115" width="20" height="5" fill="#000" />
...
const Avatar8 = () => (
  <Svg width="100" height="100" viewBox="0 0 200 200">
    ...
    <Path d="M85,105 Q100,95 115,105" stroke="#000" strokeWidth="2" fill="none" />
  </Svg>
);
